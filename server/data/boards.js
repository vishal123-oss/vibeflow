...
// Reusable wrapper to eliminate repeated load/check/save patterns in board entity operations
async function withBoard(boardId, updater) {
...
export async function updateBoard(boardId, payload) {
  return withBoard(boardId, (board) => {
...
// List operations (async FS) - using withBoard to avoid load/save duplication
...
// Card operations (async FS; load/save board after mutate) - using withBoard to avoid duplication
...
// Checklist operations (async FS) - using withBoard
...
// Comment operations (async FS) - using withBoard
...
// Label operations (async FS) - using withBoard
...
// Archive operations (async FS) - using withBoard for mutating restores
