...
const defaultTasks = [
  {
    ...
    meta: { assignee: 'User1', labels: ['backend', 'urgent'], priority: 'high' },
  ...
  },
  {
    ...
    meta: { assignee: 'User2', labels: ['frontend', 'design'], priority: 'medium' },
  ...
  },
  {
    ...
    meta: { assignee: 'User2', labels: ['design'], priority: 'low' },
